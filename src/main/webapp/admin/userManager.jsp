...
<div class="panel panel-default">
    ...
    <div class="panel-body form-group" style="margin-bottom:0px;">
        <label class="col-sm-1 control-label" style="text-align: right; margin-top:5px">用户ID：</label>
        <div class="col-sm-2">
            <input type="text" class="form-control" name="uId" id="search_uid"/>
        </div>
        <label class="col-sm-1 control-label" style="text-align: right; margin-top:5px">用户Email：</label>
        <div class="col-sm-2">
            <input type="text" class="form-control" name="uEmail" id="search_uemail"/>
        </div>
...
<script type="text/javascript">
	...
	function operation(value, row, index) {
		var htm = "<button class='btn btn-sm btn-danger'>删除</button><button class='btn btn-sm btn-info' data-toggle='modal' data-target='#modalChange' onclick='showChange(&apos;"
		 	+ row.uId
		 	+ "&apos;,&apos;"
		 	+ row.uEmail
		 	+ "&apos;,&apos;"
