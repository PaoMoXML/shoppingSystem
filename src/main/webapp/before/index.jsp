				...
				<div class="box_2">
					...
					<div class="top10List clearfix">
							<ul class="clearfix">
								...
								<li class="topimg">
								<a href="goodsDetail.jsp"> 
									<img class="samllimg" alt="" src="../images/before/103.jpg" /></a></li>
								<li class="iteration1">
								<a href="goodsDetail.jsp">水果100</a><br />
								 售价：<font class="f1">￥10元</font><br /></li>
							</ul>
							<ul class="clearfix">
								<img class="iteration" src="../images/before/top_2.gif" />
								<li class="topimg">
								<a href="goodsDetail.html"> 
									<img class="samllimg" alt="" src="../images/before/103.jpg" /></a></li>
								<li class="iteration1">
								<a href="goodsDetail.html">水果1</a><br />
								 售价：<font class="f1">￥10元</font><br /></li>
							</ul>
							<ul class="clearfix">
								<img class="iteration" src="../images/before/top_3.gif" />
								<li class="topimg">
								<a href="goodsDetail.html"> 
									<img class="samllimg" alt="" src="../images/before/103.jpg" /></a></li>
								<li class="iteration1">
							...
							<ul class="clearfix">
								<img class="iteration" src="../images/before/top_4.gif" />
								<li class="topimg">
								<a href="goodsDetail.html"> 
									<img class="samllimg" alt="" src="../images/before/103.jpg" /></a></li>
								<li class="iteration1">
							...
							<ul>
									<li>
										<div>
											<p class="pic">
												<a href="goodsDetail.html">
												<img src="../images/before/103.jpg" /></a>
											</p>
											<p class="wz">
												<strong><a href="goodsDetail.html">水果1</a></strong>
